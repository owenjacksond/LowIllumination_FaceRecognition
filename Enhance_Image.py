...
#srcDirectory = "../../../grimace/grimace/home_testing/home1.jpeg"
srcDirectory = "home_testing/low"
saveDirectory = "home_testing/test"
...
# 	if filename.endswith(".JPG") or filename.endswith(".jpg") or filename.endswith(".png") or filename.endswith(".PNG") or filename.endswith(".JPEG"):
enhImg = wrapper(srcDirectory)
enhImg.save(saveDirectory + '_enh.jpg', quality=94 ,optimize=True)
 		# print(srcDirectory)
